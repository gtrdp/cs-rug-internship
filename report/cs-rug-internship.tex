...
The BLE communication results are also presented in the same way with the WiFi communication, i.e., it is grouped to 7 groups based on location and each location consists of three combination of number of beacon.
% Bluetooth result
\begin{figure}
  \centering
